								...
								<tbody>
									...
									<tr>
										...
										<td align="center" href="#"
											onclick="window.open('http://localhost:8080/NPNC/Admin/custom_info/custom_info.jsp?idx=<%=ab.getCustom()%>', '', 'width=400, height=430'); return false;" style='cursor: pointer' background-color: #F9EDA5;><%=ab.getCustom()%></td>
										<td align=center><%=ab.getCar_kind()%></td>
