...
<jsp:useBean id="branch_employee" scope="request"
	class="Admin.branch.branch_employeeDao" />
							...
							<table width="100%">
								<thead>
									<tr
										...
										<th width="5"></th>
										<th align=center width="70">직책</th>
										<th align=center width="73">이름</th>
										<th align=center width="70">사원아이디</th>
										<th align=center width="100">연락처</th>
										<th align=center width="100">자리번호</th>
									</tr>
								...
								<tbody>
									<%
										...
										branch_employee.branch_employeeinfo(Session_ID);
										for (Admin.branch.branch_employee ab : branch_employee.getList()) {
									%>
									...
									<tr>
										...
										<td align="center" href="#"
											onclick="window.open('http://localhost:8080/NPNC/Admin/custom_info/custom_info.jsp?idx=<%=ab.getName()%>', '', 'width=400, height=430'); return false;"
											style='cursor: pointer'background-color: #F9EDA5;><%=ab.getPosition()%></td>
										<td align=center><%=ab.getName()%></td>
										<td align=center><%=ab.getId()%></td>
										<td align=center><%=ab.getPhone()%></td>
										<td align=center><%=ab.getCall()%></td>
									</tr>
								</tbody>
								<%
									}
